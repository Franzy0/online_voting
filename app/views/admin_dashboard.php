...
.logout-btn {
    background: #fff; color: #00796B; padding: 10px 18px; border-radius: 8px;
...
.card {
    background: #FFFFFF; padding: 25px; border-radius: 16px; width: 240px;
    box-shadow: 0 4px 18px rgba(0,0,0,0.08); border-top: 6px solid #56C596;
    transition: 0.3s ease;
}
.card-link { text-decoration: none; color: inherit; }
.card-link:hover .card { transform: translateY(-6px); }
.card h3 { color: #333; margin: 0 0 10px; }
...
<div class="container">
    ...
    <div class="cards">
        <a href="#" class="card-link"><div class="card"><h3>Total Voters</h3><p><?= $totalVoters ?></p></div></a>
        <a href="#" class="card-link"><div class="card"><h3>Total Candidates</h3><p><?= $totalCandidates ?></p></div></a>
        <a href="#" class="card-link"><div class="card"><h3>Total Votes</h3><p><?= $totalVotes ?></p></div></a>
    </div>
</div>
</body>
</html>
